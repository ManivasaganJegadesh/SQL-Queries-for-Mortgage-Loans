...
-- 9.  What is the approval rate of loans by state?
...
-- 10. Which states have the highest loan approval rates?
...
-- 11. Monthly Loan Applications Trend
...
-- 12.Maximum Loan Amount by Credit Score Range
select 
case
	when credit_score >= 750 then 'Excellent (>=750)'
    when credit_score between 700 and 749 then 'Good (700-749)'
...
-- 14. select borrower_name, loan_amount, credit_score, interest_rate, application_date
